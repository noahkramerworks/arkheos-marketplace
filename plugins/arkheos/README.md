...
Version 0.1.2 is the first-revenue conversion release. The public landing page now leads with Stream Showrunner, explains its reversible OBS outcome, gives new customers the complete three-step Codex installation path, and makes installation—not the device-code form—the primary action. Product, membership, signing, MCP, and service API contracts are unchanged.
