...
assert.equal(manifest.name, "arkheos"); assert.equal(manifest.version, "0.1.0"); assert.equal(manifest.skills, "./skills/"); assert.equal(manifest.mcpServers, "./.mcp.json");
...
const required = [
  ...
  "service/tests/domain.test.mjs", "service/tests/migrations.test.mjs", "service/tests/oauth.test.mjs", "service/tests/projection.test.mjs", "service/tests/worker.test.mjs",
