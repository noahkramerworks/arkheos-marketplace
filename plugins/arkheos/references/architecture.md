...
The Cloudflare service is deployed independently from `service/`. D1 owns verified customer identity, trials, paid billing projections, token families, and bounded operation records. KV owns current signed catalog and release manifests. R2 owns immutable content-addressed artifacts. Stripe owns paid subscriptions and invoices. No customer project content enters the service.
