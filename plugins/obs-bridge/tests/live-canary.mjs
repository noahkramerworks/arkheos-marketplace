...
const sceneName = "Bridge 0.1.2 Native Canary";
const inputName = "Bridge 0.1.2 Native Canary Color";
const plan = {
  planId: "obs-bridge-0.1.2-native-canary",
  actions: [
...
if (applied.status !== "verified" || applied.pluginVersion !== "0.1.2") throw new Error("OBS native apply did not verify the release version");
