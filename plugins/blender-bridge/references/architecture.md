...
The extension performs native state inspection and admitted scene actions. The coordinator owns enrollment, serialization, checkpoints, receipts, job identity, bounded logs, and external artifact staging. Product plugins may compose this bridge but may not widen its authority.
